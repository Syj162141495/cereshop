...
/**
 * cere_customer_classify 服务商分类实体类
 * @author
 */
@Data
@ApiModel(value = "CereCustomerClassify", description = "服务商分类实体类")
public class CereProductProviderClassify implements Serializable {
