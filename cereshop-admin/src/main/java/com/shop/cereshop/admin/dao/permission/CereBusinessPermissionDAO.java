...
public interface CereBusinessPermissionDAO extends BaseMapper<CerePlatformPermission> {
    ...
    int insert(CerePlatformPermission record);
    ...
    int deleteByResourceTypeAndPermission(@Param("project") Long project, @Param("resourceType") String resourceType, @Param("permissionList") List<String> permissionList);
}
