...
public class CereShopCouponServiceImpl implements CereShopCouponService {
    ...
    @Override
    public List<ProductCoupon> findByProductId(Long productId) {
        return cereShopCouponDAO.findByProductId(productId);
    }
    ...
    @Override
    public List<ProductCoupon> findByProductIdAndUserId(Long buyerUserId, Long productId) {
        return cereShopCouponDAO.findByProductIdAndUserId(buyerUserId,productId);
    }
